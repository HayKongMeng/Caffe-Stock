...
public class MenuItem extends JButton {
    ...
    public MenuItem() {
        ...
        setIcon(new javax.swing.ImageIcon(getClass().getResource("/Main/Design/icons8-m-cute-48.png")));
        initStyle();
    }

    private void initStyle() {
        Color color = UIManager.getColor("Swing.icons8-m-cute-48.ripplecolor");
        if (color != null) {
